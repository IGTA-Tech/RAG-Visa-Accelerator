      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-96 h-[500px] bg-white rounded-2xl shadow-2xl flex flex-col z-50 border border-slate-200 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-500 text-white p-4">
            <h3 className="font-bold text-lg">IGTA Media Assistant</h3>
            <p className="text-blue-100 text-sm">Ask about IGTA, story angles, statistics</p>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-slate-50">
            {messages.length === 0 && (
              <div className="text-center text-slate-500 mt-8">
                ...
                <p className="text-sm mt-2">Ask about Sherrod Seward, IGTA statistics, story angles, or media targets.</p>
              </div>
            )}
            {messages.map((msg, i) => (
